        ...
        <Box className="flex flex-col w-1/3 space-y-4">
          ...
          {attendanceData && (
            <Paper className="p-4 bg-white rounded shadow-md cursor-pointer" onClick={handleOpenModal}>
              ...
              <Typography><strong>Check In Time:</strong> {attendanceData['Check In Time']}</Typography>
              <Typography><strong>Check Out Time:</strong> {attendanceData['Check Out Time']}</Typography>
              <Typography><strong>Attendance Type:</strong> {attendanceData['Attendance Type']}</Typography>
            </Paper>
          )}
        </Box>
      </div>
